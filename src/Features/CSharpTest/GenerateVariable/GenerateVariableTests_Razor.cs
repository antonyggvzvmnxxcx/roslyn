...
{
    private const int UppercasePropertyIndex = 0;
    ...
    private async Task TestGeneratingPropertyInRazorSourceGeneratedDocumentAsync(
        ...
        bool requestFromSourceGeneratedDocument)
    {
        ...
        Assert.True(flattenedActions.Length > PropertyIndex);

        var operations = await flattenedActions[UppercasePropertyIndex].GetOperationsAsync(CancellationToken.None);
    ...
    [Fact]
    public Task TestGeneratingPropertyIntoRazorSourceGeneratedDocumentFromRegularDocument()
        => TestGeneratingPropertyInRazorSourceGeneratedDocumentAsync(
            ...
            public partial class Component
            {
                public static object Prop { get; internal set; }
            }
            """,
            requestFromSourceGeneratedDocument: false);

    [Fact]
    public Task TestGeneratingPropertyInRazorSourceGeneratedDocument()
        => TestGeneratingPropertyInRazorSourceGeneratedDocumentAsync(
            """
            <Workspace>
                <Project Language="C#" AssemblyName="ClassLibrary1" CommonReferences="true">
            ...
            public partial class Component
            {
                public object MissingProp { get; private set; }
    ...
    [Fact]
    public Task TestGeneratingPropertyIntoHiddenRazorSourceGeneratedDocumentFromRegularDocument()
        => TestGeneratingPropertyInRazorSourceGeneratedDocumentAsync(
            """
            <Workspace>
                <Project Language="C#" AssemblyName="ClassLibrary1" CommonReferences="true">
    ...
    [Fact]
    public Task TestGeneratingPropertyInHiddenRazorSourceGeneratedDocument()
        => TestGeneratingPropertyInRazorSourceGeneratedDocumentAsync(
            """
            <Workspace>
                <Project Language="C#" AssemblyName="ClassLibrary1" CommonReferences="true">
